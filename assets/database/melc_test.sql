...
(2, 'Parque Biblioteca La Ladera', '¡¿Vas para la antigua cárcel de varones de la ciudad?! En 1921, un ingeniero belga, el mismo que construyó el Palacio de la Cultura, la Facultad de Derecho de la Universidad de Antioquia y la Iglesia del Sagrado Corazón, comenzó su construcción ¿Sabes cómo se llamaba el ingeniero? ¿desde cuándo se transformó en parque y en biblioteca? Este equipamiento representa la memoria, porque antiguamente fue la cárcel de varones La Ladera. Ya lo hemos visitado varias veces y siempre nos reciben con múltiples actividades y nuevos conocimientos. El trabajo que han hecho para recuperar la memoria del barrio desde sus habitantes es reconocido en toda la ciudad.', 6.2506827, -75.5563988, 'https://goo.gl/maps/VcXFqzSzBwy', 1, '2018-08-22 06:11:01', '0000-00-00 00:00:00'),
